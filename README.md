## 说明
本仓库完善了 [data/category-pt](https://github.com/ixff/domain-list-community/blob/master/data/category-pt)，只用作 [ixff/domain-list-custom](https://github.com/ixff/domain-list-custom) 的数据源。
